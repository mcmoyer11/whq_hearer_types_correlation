...
// QUESTIONS TRIALS - MENTION-ALL GOALS

Sequence("intro",
    // familiarization of cards
    "familiarize1","familiarize2","familiarize3","familiarize4",
    // instructions and set-up of discourse goals
    "instructions1","instructions2","instructions3",
    // training for evaluating reports
    "trainF","trainT","trainthink1","trainthink2","end_train", 
    // test items
    randomize("trial"),
    // send results and end page
    "send", "end")
...
newTrial( "instructions2",
    ...
    ,
    newText("<p>The goal of this game is to collect points.</p>")
    ,
    newText("<p>If a player plays a certain card, they will receive a point.</p>")
    ,
    newText("<p>The players with the most points at the end can move on to the second round.</p>")
    ,
    newText("<p>Thus, it is important to keep an accurate account of the points.</p>")
    ,
    newButton("Continue")
        .center()
        .print()
...
newTrial( "instructions3",
    ...
    newText("<p><strong>INSTRUCTIONS.</strong></p>")
    ,
    newText("<p>Dana has never played cards, or this game before.</p>")
    ,
    newText("<p>Her friend Melissa is going to help her learn.</p>")
    ,
    newText("<p>We will ask Dana a question about the cards, and she will give an answer.</p>")
    ,
    newText("<p>Then Melissa will make a statement about what Dana said.</p>")
    ,
    newText("<p>Melissa is not an expert, so sometimes we have to help her out too.</p>")
    ,
    newText("<p><strong>Your task is to help them both by saying whether you agree or disagree with Melissa's statement.</strong></p>")
    ,
    newButton("Continue")
        .center()
        .print()
...
newTrial( "trainF",
        ...
        newText("<p><strong>We will ask Dana a question:</strong></p>")
            ...
            .print()
        ,
        newText( `"Players with a four get a point. Who has a four?"` )
            .center()
            .print()
        ,
        ...
        newText(`Dana: "F."`)
            ...
            .print()
        ,
        newText("<p><strong>And Melissa will make a statement about what Dana said:</strong></p>")
            .center()
            .print()
        ,
...
newTrial( "trainT",
        ...
        newImage("train_report2", "train_report2.png")
            ...
            .print()
        ,
        newText( `"Players with a Jack get a point. Who has a Jack?"` )
            .center()
            .print()
        ,
        newText(`Dana: "B."`)
        ...
        newText( `Melissa: "Dana got it right!"` )
            ...
            .print()
        ,
        newText("<p> If you <strong>Agree</strong> with the statement, press <strong>F</strong>. If you <strong>Disagree</strong>, then press <strong>J</strong><p>")
            .center()
            .print()
        ,
...
newTrial( "trainthink1",
        ...
        newImage("train_think1", "train_think1.png")
            ...
            .print()
        ,
        newText( `"Players with a five get a point. Who has a five?"` )
            .center()
            .print()
        ,
...
newTrial( "trainthink2",
        ...
        newImage("train_think2", "train_think2.png")
            ...
            .print()
        ,
        newText( `"Players with a two get a point. Who has a two?"` )
            .center()
            .print()
        ,
        newText(`Dana: "B."`)
