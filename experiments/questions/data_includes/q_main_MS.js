...
// QUESTIONS TRIALS - MENTION-SOME GOALS

Sequence("intro","familiarize1", "familiarize2","familiarize3","familiarize4","instructions1", "instructions2","instructions3", "trainF","trainT","trainthink1","trainthink2", "end_train", randomize("trial"), "send", "end")
...
newTrial( "trainF",
        ...
        newImage("train_report1", "train_report1.png")
            ...
            .print()
        ,
        newText("<p><strong>We ask Dana a question:</strong></p>")
            .center()
            .print()
        ,
        newText( `"Let's say you play a four. Who has a four to play?"` )
            ...
            .print()
        ,
        newText("<p><strong>Dana will give an answer:</strong></p>")
            .center()
            .print()
        ,
        newText(`Dana: "F."`)
